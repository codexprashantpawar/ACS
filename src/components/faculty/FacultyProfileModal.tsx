...
//                   </thead>
//                   <tbody>
//                     {faculty.qualification.map((edu, index) => (
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="p-0">
        {/* Header */}
        <DialogHeader className="p-3" style={{ backgroundColor: "#007bff", color: "#fff" }}>
          <DialogTitle className="h5 mb-0">Faculty Profile</DialogTitle>
        </DialogHeader>
          ...
          <div className="row g-0 align-items-center">
            ...
            <div className="col-md-8 p-3">
              ...
              <div className="row text-dark">
                ...
                <div className="col-sm-6 mb-2">
                  <strong>Specialisation:</strong> {faculty.specialisation}
                </div>
                <div className="col-sm-6 mb-2">
                  <strong>Publications:</strong> {faculty.publications > 0 ? faculty.publications : "Nil"}
                </div>
                <div className="col-sm-6 mb-2">
                  <strong>Awards:</strong> {faculty.awards > 0 ? faculty.awards : "Nil"}
                </div>
              </div>
            </div>
          </div>
