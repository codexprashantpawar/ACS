import { commerceCourses } from "@/data/academics/CommerceData";
  ...
  return (
    <Layout>
      <PageHeader
        ...
        description="Explore Commerce & Management courses, eligibility, fees, and syllabus at SNBP ACS"
        breadcrumbs={[
          { label: "Academics", href: "/academics/commerce" },
          { label: "Commerce" },
        ]}
      />
